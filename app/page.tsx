...
export default function HomePage() {
  ...
  }, [concursos, texto, distrito, carrera]);
  ...
  function estadoConcurso(c: Concurso): { label: string; cls: string } {
    ...
    if (ini && ini > hoy) return { label: 'Próximo', cls: 'bg-brand-50 text-brand-600 border-brand-200' };
    ...
    <div className="min-h-screen pb-28">
        ...
        <section className="max-w-4xl mx-auto px-5 mt-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-white border-2 border-slate-100 rounded-2xl p-5 text-center hover:border-pink-300 hover:bg-pink-50 transition group"
            >
              <span className="text-2xl block mb-2">💜</span>
              <span className="text-sm font-bold text-slate-700 group-hover:text-pink-600">
                Asesoramiento
              </span>
            </a>
            <button
      ...
      <footer className="max-w-5xl mx-auto px-5 mt-16 mb-6 text-center">
        <p className="text-[11px] text-slate-300">
          ...
          <a href="/admin" className="hover:text-slate-400" aria-label="Acceso administrador">
            ⚙
          </a>
        </p>
      </footer>
